...
public class Home extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Glide.with(this)
                ...
                .into(imageView);
        // Tạo ObjectAnimator để di chuyển imageView theo trục X
        ObjectAnimator animator = ObjectAnimator.ofFloat(imageView, "translationX", -520f, 520f); // Khoảng cách di chuyển
        animator.setDuration(6000); // Thời gian di chuyển
