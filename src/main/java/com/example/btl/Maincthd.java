...
public class Maincthd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mathue != null) {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                if (giaxeValue != 0) {  // Kiểm tra tránh chia cho 0
                    double soluongValue = (double) tongphiValue / giaxeValue;
        ...
        btthoat.setOnClickListener(v -> {
            // Quay lại Activity Xecuatoi
            Intent intent = new Intent(Maincthd.this, XeCuaToi.class);
            startActivity(intent);
            finish(); // Kết thúc Activity hiện tại (Maincthd) và quay lại Xecuatoi
        });
    }
}
